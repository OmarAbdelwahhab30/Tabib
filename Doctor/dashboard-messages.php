        ...
        <div class="container-fluid overflow-hidden">
            <div class="row margin-tb-90px margin-lr-10px sm-mrl-0px">
                ...
                <div class="margin-tb-45px">
                    ...
                    $query  ="SELECT  patients.img_path,messages.id,patients.username ,messages._datetime, patients.first_name , patients.last_name 
                  , messages.patient_message FROM patients INNER JOIN messages ON messages.patient_id = patients.id where doctor_id =$DOCTOR_ID";
                    ...
                    <div class="background-white thum-hover box-shadow hvr-float full-width margin-bottom-45px">
                        ...
                        <div  style=" width: 1000px;" class="background-white thum-hover box-shadow hvr-float full-width margin-bottom-45px">
                            <p class="text-grey-2" style="color: dodgerblue ;margin: 10px 10px 10px 300px;font-size: 22px; ">No Data To Show</p></div>
                    <?php } ?>
                </div>
        </div>
        <!-- /.container-fluid-->
