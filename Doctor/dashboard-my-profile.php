...
$doctor_img = $_SESSION['DOCTOR_IMG_PATH'];
            ...
            <div class="row">
                ...
                <div class="col-xl-4 d-none d-xl-block">
                    ...
                    <div class="nav-item dropdown float-left">
                        <a href="dashboard-my-profile.php" class="margin-top-15px d-inline-block text-grey-3 margin-right-15px"><img src="imgs/<?php
                                                                        if($doctor_img == ''){
                                                                            echo "profile.png";
                                                                        } else {
                                                                            echo "$doctor_img";
                                                                        }
                                                        ?>" class="height-30px border-radius-30" alt=""><?="   ".$_SESSION['DOCTOR_FIRSTNAME']."  ".$_SESSION['DOCTOR_LASTNAME']?></a>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="padding-15px background-white">
                            ...
                            <form action="imgProcess.php?docid=<?=$_SESSION['DOCTOR_ID']?>" method="post" enctype="multipart/form-data">
                                <a href="#" class="d-block margin-bottom-10px"><img src="imgs/<?php
                                                                        if($doctor_img == ''){
                                                                            echo "profile.png";
                                                                        } else {
                                                                            echo "$doctor_img";
