...
if(isset($_POST['subit'])){
    ...
    $day_of_appointment = $_POST['dayOfAppointment'];
    
    $added = queryHandler::AddData('appointment','patient_id,doctor_id,cause,time_appointment,time_reservation,day_appointment',
                        "'$patient_id','$doctor_id','$cause','$doctor_time_presence','$time_of_reservation','$day_of_appointment'");
