        ...
        <div class="container-fluid overflow-hidden">
            <div class="row margin-tb-90px margin-lr-10px sm-mrl-0px">
                ...
                <div class="row margin-top-45px">
                    ...
                    <?php
                       require_once 'admin-pagination-f-appoint.php';
                  
                       $appoint_boolean = queryHandler::getData("(SELECT id,username FROM patients) patients join appointment on patients.id = appointment.patient_id JOIN doctors on doctors.id = appointment.doctor_id"
                       ,"appointment.appointment_id,appointment.patient_id,appointment.time_reservation,appointment.day_appointment,appointment.time_appointment,appointment.doctor_id,appointment.cause,patients.username as patient_name,doctors.username as doctor_name",
                                            ...
                                            <div class="background-white thum-hover box-shadow  hvr-float">
                                                <div class="padding-30px full-width">
                                                    <div class="margin-left-85px">
                                                        ...
                                                        <div class="d-block padding-tb-5px">Day Of Appointement  :  <a href="#" class="text-main-color"><?= $one_row['day_appointment'] ?></a></div>
                                                        ...
                                                        <a href="admin-delete-appoint.php?id=<?=$one_row['appointment_id'] ?>" class="d-inline-block margin-lr-20px text-grey-2 text-up-small"><i class="far fa-window-close"></i> Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>                                
