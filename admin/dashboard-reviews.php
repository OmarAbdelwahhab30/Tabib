        ...
        <div class="container-fluid overflow-hidden">
            <div class="row margin-tb-90px margin-lr-10px sm-mrl-0px">
                ...
                <div class=" margin-tb-45px">
                    ...
                    <?php
                       require_once 'admin-pagination-f-reviews.php';
                                    ...
                                    <div class="background-white thum-hover box-shadow hvr-float" style="width:400px;">
                                        <div class="padding-30px" >
                                            ...
                                            <div class="margin-left-85px">
                                                ...
                                                <a href="admin-delete-review.php?id=<?=$one_row['id'] ?>" class="d-inline-block margin-lr-20px text-grey-2 text-up-small"><i class="far fa-window-close"></i> Delete</a>
                           ...
                           <?php }
                            ...
                            <div class="background-white thum-hover box-shadow hvr-float full-width margin-bottom-45px" style="width: 600px;">
                                <div class="padding-lr-25px padding-tb-45px" >
                                    <h2 class="font-weight-300" style="margin-left: 60px;color:dodgerblue">No Reviews To Show</h2>
                                </div>
                            </div>
                            <?php
                        }
