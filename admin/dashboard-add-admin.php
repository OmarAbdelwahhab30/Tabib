                ...
                <div class="row margin-tb-90px margin-lr-10px sm-mrl-0px">
                    ...
                    <div class="margin-tb-45px full-width">
                        <div class="padding-30px background-white border-radius-20 box-shadow">
                            ...
                            <hr>
                            <form method="post" action="addadminProcess.php">
                                <div class="form-group margin-bottom-20px">
                                    <label><i class="far fa-list-alt margin-right-10px"></i>Admin.Username</label>
                                    <input type="text" name="adminusername" class="form-control form-control-sm" id="ListingTitle" placeholder="name" required>
                                </div>
                               
                                <div class="form-group margin-bottom-20px">
                                    <label><i class="far fa-flag margin-right-10px"></i> Password</label>
                                    <input type="password" name="password" class="form-control form-control-sm" id="ListingKeywords" placeholder="password" required>
                                </div>
                                <div class="form-group margin-bottom-20px">
                                    <label><i class="far fa-flag margin-right-10px"></i>Confirm Password</label>
                                    <input type="password" name="confpassword" class="form-control form-control-sm" id="ListingKeywords" placeholder="Confirm password" required>
                                </div>
                                <div class="form-group margin-bottom-20px">
                                ...
                                <div class="row">
                                    <div class="col-md-6 margin-bottom-20px">
                                        ...
                                        <input type="text" name="phone" class="form-control form-control-sm" placeholder="002229456987" required>
                                    </div>
                                    <div class="col-md-6 margin-bottom-20px">
                                        <label><i class="far fa-envelope-open margin-right-10px"></i> Email</label>
                                        <input type="text" name="email" class="form-control form-control-sm" placeholder="info@yourname.com" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label><i class="fas fa-info margin-right-10px"></i> Address</label>
                                        <input type="text" name="address" class="form-control form-control-sm" placeholder="Ex Alexandria" required>
                                    </div>
                                    <input name="submit" type="submit" style="cursor: pointer; margin-top: 21px;" value="Add Admin" class="btn btn-lg border-2  btn-primary btn-block border-radius-15 padding-15px box-shadow">
                                </div>
                            </form>
                        </div>
                    </div>
