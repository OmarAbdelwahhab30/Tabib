        ...
        <div class="container-fluid overflow-hidden">
            <div class="row margin-tb-90px margin-lr-10px sm-mrl-0px">
                ...
                <div id="page-title" class="padding-30px background-white full-width box-shadow">
                    <div class="container">
                        <ol class="breadcrumb opacity-5">
                            ...
                            <li class="active">My Doctors</li>
                        </ol>
                        <h1 class="font-weight-300">My Doctors</h1>
                    </div>
                </div>
                <!-- // Page Title -->
                ...
                <?php
                   ...
                   require_once 'admin-pagination-f-doc.php';  //exist in patient folder
                               ...
                               <div class="background-white thum-hover box-shadow hvr-float full-width margin-bottom-45px" style="width: 600px;">
                                   <div class="padding-lr-25px padding-tb-45px" >
                                       <div class="float-lg-left margin-right-30px sm-mr-0px text-center sm-mt-35px">
                                           <img  src="../Doctor/imgs/<?=isset($one_row['img_path'])?$one_row['img_path']:"profile.png"?>" alt="" style="border-radius:5px; width: 250px; height:220px">
                                       </div>
                                       ...
                                       <a href="admin-delete-doctor.php?id=<?=$one_row['id'] ?>" class="d-inline-block margin-lr-30px text-grey-2 text-up-small" style="margin-left: 400px;margin-top: 10px"><i class="far fa-window-close"></i> Delete</a>
                                    </div>
